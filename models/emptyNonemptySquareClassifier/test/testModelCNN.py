...
filePath = 'data/testData/emptyNonemptySquare'
filePathForEvaluate = 'data/testData/emptyNonemptySquare'


classifier = load_model( os.path.join("models/emptyNonemptySquareClassifier/trainedModelCNN.h5") )

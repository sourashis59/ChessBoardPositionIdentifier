...
filePath = 'data/testData/blackOrWhitePieces'
filePathForEvaluate = 'data/testData/blackOrWhitePieces'


classifier = load_model( os.path.join("models/blackOrWhitePieceClassifier/trainedModelCNN.h5") )
classes = ['blackPiece', 'whitePiece']

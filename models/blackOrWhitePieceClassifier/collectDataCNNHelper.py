    ...
    if ( fileName.endswith(".jpg") or fileName.endswith(".png") ) :                 
        ...
        for i in range(0, len(squares)):
            for j in range(0, len(squares[i])):
                ...
                if(pieceType != 'NULL') :
                    resizedImage.save(f"{destPath}/{pieceColor}Piece/{pieceType}_{pieceColor}_{imageCount}.png")
                    imageCount += 1
    ...
    if ( fileName.endswith(".jpg") or fileName.endswith(".png") or fileName.endswith(".jpeg") ) :                 
        ...
        for i in range(8) :
            for j in range(8) :
                ...
                if(pieceType != 'NULL') :
                    squareImages[i][j].save(f"{destPath}/{pieceColor}Piece/{pieceType}_{pieceColor}_kaggleData_{imageCount}.png")
                    imageCount += 1
